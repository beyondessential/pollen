...
-- content-addressed ruleset they are bound against. Finalizing freezes the
-- binding. See spec WIZ (Artifact lifecycle, Content-addressed binding).

CREATE TYPE application_status AS ENUM ('draft', 'finalized');
...
-- a draft/finalized status, and lineage back to the version it was forked from.
